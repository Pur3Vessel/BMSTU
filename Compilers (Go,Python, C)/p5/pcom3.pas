...
1:  fcp := lcp
  ...
  procedure searchidn(fidcls: setofids; var fcp: ctp);
    var mm: boolean;
  begin
  ...
  procedure searchid(fidcls: setofids; var fcp: ctp);
    ...
    var lcp: ctp;
  begin
    searchidn(fidcls, lcp); { perform no error search }
  ...
  procedure block(fsys: setofsys; fsy: symbol; fprocp: ctp);
    ...
    begin
      ...
      if fsp <> nil then with fsp^ do case form of
        ...
        records:  if filecompo(fstfld) then f := true;
        files:    f := true;
        tagfld:   ;
        variant:  ;
      end;
